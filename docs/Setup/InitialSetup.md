...
2. Install .NET Desktop Runtime 10 if you do not have it installed already. You can download it [here](https://dotnet.microsoft.com/en-us/download/dotnet/10.0) — pick the latest `Desktop Runtime` / Windows x64 installer.
