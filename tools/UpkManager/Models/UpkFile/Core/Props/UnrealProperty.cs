...
namespace UpkManager.Models.UpkFile.Core
{
    ...
    public sealed class UnrealProperty
    {
        ...
        public ResultProperty ReadProperty(UBuffer buffer, UObject parent)
        {
            ...
            {
                Console.Error.WriteLine($"Error reading property '{NameIndex?.Name}': {ex.Message}");
            ...
            {
                Console.Error.WriteLine($"Error reading property value '{NameIndex.Name}': {ex.Message}");
                return ResultProperty.Error;
            }
