...
namespace UpkManager.Models.UpkFile.Engine.Mesh
{
    ...
    public class USkeletalMeshComponent : UMeshComponent
    {
        ...
        // Per-instance placement (4H: character placement). Same shape as SMC.
        ...
        // Same cooked-prefix override as UStaticMeshComponent — UComponent's
        // TemplateOwnerClass+TemplateName get stripped to a 4-byte 0xFFFFFFFF
        // marker. Verified via the smcprobe pattern; if a SkelMC fails to
        // populate, run `UpkExtract.exe smcprobe` on that .upk after teaching
        // it to also dump SkeletalMeshComponent class exports.
        public override void ReadBuffer(UBuffer buffer)
        {
